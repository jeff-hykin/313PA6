...
// Constructors
// 
    FifoRequestChannel::FifoRequestChannel(const std::string _name, const Side _side) : my_name(_name), my_side(_side), side_name((_side == FifoRequestChannel::SERVER_SIDE) ? "SERVER" : "CLIENT")
        {
            // Summary:
